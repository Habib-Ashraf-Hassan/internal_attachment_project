...
<body class="body-home">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
        <img src="images/Madrassa_logo2.png" alt="Madrassa logo" width="30">
    </a>
    ...
    <section id="about" class="d-flex justify-content-center align-items-center flex-column">
        ...
        <div class="row g-0">
            <div class="col-md-4">
            <img src="images/Madrassa_logo2.png" class="img-fluid rounded-start" alt="Logo">
            </div>
            <div class="col-md-8">
            <div class="card-body">
