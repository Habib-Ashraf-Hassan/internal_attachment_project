...
if (isset($_POST['fname'])      &&
    ...
    if (empty($fname)) {
        ...
        $stmt->execute([$uname,  $classes, $fname, $lname, $subjects, $address, $employee_number, $date_of_birth, $phone_number,$gender, $email_address,        $teacher_id]);
