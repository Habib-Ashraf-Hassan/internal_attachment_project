           ...
           <form action="" 
             ...
             <div class="input-group mb-3">
                ...
                <select class="form-control" name="searchKey"
                    ...
                    <option value="current_year_current_semester">Current year, Current semester</option>
                    <option value="current_year_previous_semester">Current year, previous semester</option>
                    <option value="current_year">Previous year</option>
